...
# ---------------------------------------------------------------------------
# Dynamic Admin Billing Endpoints (어드민 과금 금액 실시간 변경)
# ---------------------------------------------------------------------------
@router.get("/admin/billing/rates", response_model=BillingRateConfig)
...
@router.put("/admin/billing/rates", response_model=BillingRateConfig)
...
@router.post("/admin/nodes/set-multiplier")
